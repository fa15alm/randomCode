...
if p1name.lower() in names:
    strength = re.findall('\'' + p1name.lower() + '\': Strength: \'(.*)\', Skill: ', contents)
    skill = re.findall('\', Skill: \'(.*)\'', contents)
    print('Welcome back, ' + p1name.lower() + '! Your Strength is ' + strength[0] + ', and your Skill is ' + skill[0])

if p2name.lower() in names:
    strength = re.findall('\'' + p2name.lower() + '\': Strength: \'(.*)\', Skill: ', contents)
    skill = re.findall('\', Skill: \'(.*)\'', contents)
    print('Welcome back, ' + p2name.lower() + '! Your Strength is ' + strength[0] + ', and your Skill is ' + skill[0])
